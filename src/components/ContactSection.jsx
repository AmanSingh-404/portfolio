...
const ContactSection = () => {
    ...
    const handleSendMessage = (e) => {
        ...
        const mailtoLink = `mailto:amans64788@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
            `Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`
        )}`;
        ...
        <section id="contact" className="relative w-full py-32 bg-slate-50 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row gap-20">
                ...
                <div className="md:w-1/2 space-y-10">
                    <div>
                        ...
                        <h2 className="text-5xl md:text-6xl font-black text-slate-900 font-heading leading-tight">
                            Let's Work <br />
                            <span className="text-transparent bg-clip-text bg-linear-to-r from-cyan-500 to-blue-600">Together.</span>
                        </h2>
                    </div>
                ...
                <div className="md:w-1/2">
                    <form onSubmit={handleSendMessage} className="bg-white p-8 md:p-10 rounded-4xl shadow-xl shadow-slate-200/50 border border-slate-100 space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 border-b-2 border-slate-200 p-3 focus:outline-none focus:border-cyan-500 transition-colors font-bold text-slate-900"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                className="w-full bg-slate-50 border-b-2 border-slate-200 p-3 focus:outline-none focus:border-cyan-500 transition-colors font-bold text-slate-900 resize-none"
